//https://mp.weixin.qq.com/s/bde_5ByBeSblJxDDF_Egow
/**
    算 法
 */
//不用中间变量，用两种方法交换A、B的值
...
/**
 选择排序：最值出现在起始端
 第一趟:在n个数中找到最小(大)数与第一个数交换位置
 第二趟:在剩下n-1个数中找到最小(大)数与二个数交换位置
...
/**
 ...
 第一趟：依次比较相邻的两个数，不断交换(小数放前，大数放后)逐个推进，最值最后出现在第n个元素位置
 第二趟：依次比较相邻的两个数，不断交换(小数放前，大数放后)逐个推进，最值最后出现在第n-1个元素位置
 ..........
